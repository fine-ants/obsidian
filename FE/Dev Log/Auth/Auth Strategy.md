...
```json
{
	"authURL": "https://accounts.google.com/o/oauth2/v2/auth?client_id=${CLIENT_ID}&redirect_uri]${REDIRECT_URI_TO_BACKEND}&response_type='code'&scope=openid profile&code_challenge_method=S256",
