...
리소스를 보호하고 권한을 위임하기 위해 OAuth2를 사용하는 시스템은 어쨌든 모든 "정상적인" CSRF 공격에 취약합니다. 그리고 사용자가 인증하고 상태가 변경될 수 있습니다. 여기서는 OAuth2 프로토콜에 특정한 공격을 집중합니다. 이러한 맥락에서 해커는 사용자가 할 수 있는 모든 것(토큰 범위 내에서)을 수행할 수 있는 액세스 토큰을 얻으려고 할 것입니다.
