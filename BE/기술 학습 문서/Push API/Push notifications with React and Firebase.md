...
다음 화면에서 첫번째 캠페인 만들기 버튼을 클릭합니다.
![[Pasted image 20240131141154.png]]

다음과 같이 제목과 내용을 작성합니다.
![[Pasted image 20240131141225.png]]

테스트 메시지 전송 버튼을 클릭하여 클라이언트가 FCM 서버로부터 발급받은 토큰을 등록합니다.
